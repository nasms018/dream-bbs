...
export default function NewReply({auth, reply, replyOnReply, onInputReplyContent, mngReply}) {
    console.log(reply);
        if (!auth.userNick)
            return;
        return (
            <Container>
                ...
                <Row>
                    ...
                    onInput={(e)=>onInputReplyContent(e,reply.id)} value={replyOnReply.get(reply.id)} 
